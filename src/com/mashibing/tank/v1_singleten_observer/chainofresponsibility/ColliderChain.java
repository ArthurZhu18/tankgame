...
import com.mashibing.tank.v1_singleten_observer.PropertyManager;
    ...
    private void intiColliders() {
        ...
        try {
            for (String name : collidersNames) {
                Class clazz = Class.forName("com.mashibing.tank.v1_singleten_observer.chainofresponsibility."+ name);
