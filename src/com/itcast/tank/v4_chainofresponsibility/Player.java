...
import com.itcast.tank.v4_chainofresponsibility.strategy.FireStrategy;
...
//            Class clazz = Class.forName("com.mashibing.tank.v1.strategy."+strategy);
            Class clazz = loader.loadClass("com.itcast.tank.v4_chainofresponsibility.strategy."+strategy);
