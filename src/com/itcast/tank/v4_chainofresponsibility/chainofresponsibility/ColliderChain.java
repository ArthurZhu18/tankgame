...
import com.itcast.tank.v4_chainofresponsibility.PropertyManager;
    ...
    private void intiColliders() {
        ...
        try {
            for (String name : collidersNames) {
                Class clazz = Class.forName("com.itcast.tank.v4_chainofresponsibility.chainofresponsibility."+ name);
